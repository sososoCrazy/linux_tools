...
alias vcs_version_help='sh /export/pfs/home/lte_soc/guosijia/.tools/version_controller/vcs_version_help.sh'
alias vcs_version_controller_update='echo -e "\nvcs version controller code::" && cat ~guosijia/.tools/version_controller/vcs_version.sh && echo -e "\n\nvcs version help and update:" && cat ~guosijia/.tools/version_controller/vcs_version_help.sh '
...
vcs2014()
{
	...
	export PATH=/export/pfs/edatools/synopsys/vcs-mx_vJ-2014.12-SP1/bin:/export/pfs/edatools/synopsys/vcs-mx_vJ-2014.12-SP1/linux/bin:/export/pfs/edatools/synopsys/vcs-mx_vJ-2014.12-SP1/amd64/bin:$PATH
	if [ $? -eq 0 ]; then vcs2014_suc1=1; else vcs2014_suc1=0; fi
	export LD_LIBRARY_PATH=/export/pfs/edatools/synopsys/vcs-mx_vJ-2014.12-SP1/linux/lib:/export/pfs/edatools/synopsys/vcs-mx_vJ-2014.12-SP1/amd64/lib:$LD_LIBRARY_PATH
...
vcs2018()
{
	...
	export PATH=/export/pfs/edatools/synopsys/vcs-mx_vO-2018.09-SP2/vcs-mx/O-2018.09-SP2/bin:/export/pfs/edatools/synopsys/vcs-mx_vO-2018.09-SP2/vcs-mx/O-2018.09-SP2/linux64/bin:$PATH
	if [ $? -eq 0 ]; then vcs2018_suc1=1; else vcs2018_suc1=0; fi
	export LD_LIBRARY_PATH=/export/pfs/edatools/synopsys/vcs-mx_vO-2018.09-SP2/vcs-mx/O-2018.09-SP2/linux64/lib:/export/pfs/edatools/synopsys/vcs-mx_vO-2018.09-SP2/vcs-mx/O-2018.09-SP2/amd64/lib:$LD_LIBRARY_PATH
...
vcs2016()
{
	...
	export PATH=/export/pfs/edatools/synopsys/VCS_vL-2016.06-SP2/bin:/export/pfs/edatools/synopsys/VCS_vL-2016.06-SP2/linux64/bin:$PATH
	if [ $? -eq 0 ]; then vcs2016_suc1=1; else vcs2016_suc1=0; fi
	export LD_LIBRARY_PATH=/export/pfs/edatools/synopsys/VCS_vL-2016.06-SP2/linux64/lib:/export/pfs/edatools/synopsys/VCS_vL-2016.06-SP2/amd64/lib:$LD_LIBRARY_PATH
