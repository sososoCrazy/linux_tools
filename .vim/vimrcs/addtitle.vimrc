...
"	call append(2,"    > Author        : gsj")
"	call append(3,"    > Mail          : guosj.so@gmail.com")
...
"		call append(line(".")+2, "#   > Mail:          guosj.so@gmail.com") 
