...
#pwd_user=`cd ~ && pwd`
alias ps='ps auxf'
alias tree='/export/pfs/home/lte_soc/guosijia/.tools/tree/bin/tree -l -F'
alias rmps='ps | grep $my_name'
alias rmkill='kill_all_process'
# Help
#sh /export/pfs/home/lte_soc/guosijia/.tools/trash/rmhelp.sh
alias rmhelp='sh ~/.tools/trash/rmhelp.sh' 
alias rmupdate='echo -e "\ntrash code::" && cat /export/pfs/home/lte_soc/guosijia/.tools/trash/trash.sh && echo -e "\n\nrmhelp and rmupdate:" && cat /export/pfs/home/lte_soc/guosijia/.tools/trash/rmhelp.sh '
...
restorefile() 
{ 
#sh /export/pfs/home/lte_soc/guosijia/.tools/trash/trash.sh
	if [ ! -z $@ ]; then
...
#sh /export/pfs/home/lte_soc/guosijia/.tools/trash/trash_auto_rm.sh &
